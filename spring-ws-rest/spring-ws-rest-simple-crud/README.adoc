...
This guide will take you through creating a "my.study.hello world" link:/understanding/REST[RESTful web service] with Spring Boot Actuator. You'll build a service that accepts an HTTP GET request:

[source,sh]
----
$ curl http://localhost:9000/my.study.hello-world
----
...
`src/main/java/my.study.hello/HelloWorldConfiguration.java`
[source,java]
----
include::initial/src/main/java/my.study.hello/HelloWorldConfiguration.java[]
----
...
You want to handle GET requests for `/my.study.hello-world`, optionally with a name query parameter. In response to such a request, you will send back JSON, representing a greeting, that looks something like this:
...
`src/main/java/my.study.hello/Greeting.java`
[source,java]
----
include::complete/src/main/java/my.study.hello/Greeting.java[]
----

Now that you'll create the endpoint controller that will serve the representation class.

== Create a resource controller
In Spring, REST endpoints are just Spring MVC controllers. The following Spring MVC controller handles a GET request for /my.study.hello-world and returns the `Greeting` resource:

`src/main/java/my.study.hello/HelloWorldController.java`
[source,java]
----
include::complete/src/main/java/my.study.hello/HelloWorldController.java[]
----
...
[source,java]
----
include::complete/src/main/java/my.study.hello/HelloWorldConfiguration.java[]
----
...
The `@SpringBootApplication` also brings in a http://docs.spring.io/spring/docs/{spring_version}/javadoc-api/org/springframework/context/annotation/ComponentScan.html[`@ComponentScan`], which tells Spring to scan the `my.study.hello` package for those controllers (along with any other annotated component classes).
...
Test it:
....
$ curl localhost:8080/my.study.hello-world
...
$ curl localhost:9000/my.study.hello-world
{"id":1,"content":"Hello, Stranger!"}
